...
import { getActiveDeal } from "@/lib/actions/handler/admin/admin.deal.actions";
import { getBanner } from "@/lib/actions/handler/home.actions";
import { getLatestProducts } from "@/lib/actions/handler/product.actions";
import { PATH } from "@/lib/constants";
import { restartTypeSense } from "@/lib/typesense/restart-typesense";
import Link from "next/link";

const HomePage = async () => {
  const { data: latestProduct } = await getLatestProducts();
